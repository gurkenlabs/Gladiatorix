...
public class Shop implements IRenderable, KeyPressedListener {
  ...
  public Shop(List<ShopEntry> offers, List<ShopEntry> storage, BufferedImage background) {
    this.background = Imaging.scale(background, 2.5d);
    this.offers = offers;
  ...
  private void updateMenus() {
    ...
    final double wOff = (Game.window().getResolution().width - background.getWidth()) / 2d + 56, hOff =
        (Game.window().getResolution().height - background.getHeight()) / 2d + 140;
