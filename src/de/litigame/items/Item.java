...
public class Item {
  ...
  public interface Consumable {
    ...
    default void consume(Creature consumer) {
      for (ConsumeListener listener : getConsumeListeners())
        listener.onConsume(consumer);
    }
  ...
  public Item(Map<String, String> itemInfo) {
    ...
    BufferedImage image = Resources.images().get(spriteName+".png");
    sprite = new Spritesheet(image, spriteName, image.getWidth(), image.getHeight());
